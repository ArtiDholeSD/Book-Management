...
const updateReview = async function (req, res) {
  try {
    ...
    // const review = await reviewModel.findOne({bookId:booksId, _id: reviewId,isDeleted :false });
    // if (!review) {
    //   return res.status(400).send({ status: false, msg: " reviewId doesnot match or exist for this bookid" });
    // }
